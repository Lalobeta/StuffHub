...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerAdapter<Cart , CartViewHolder> adapter
            ...
            @Override
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int i, final Cart model)
            {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists())
                {
                    ...
                    if(shippingState.equals("shipped"))
                    {
                        ...
                        txtMsg1.setText("Congratulations, your final order has been shipped successfully. Soon you will received your order at your home address");
