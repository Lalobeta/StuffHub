...
public class SellerAddNewProductActivity extends AppCompatActivity {
    ...
    private void StoreProductInformation() {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            Toast.makeText(SellerAddNewProductActivity.this, "Product image uploaded successful", Toast.LENGTH_SHORT).show();
            ...
            Task<Uri> urlTask= uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
...

                    {
                        ...
                        Toast.makeText(SellerAddNewProductActivity.this,"Getting product image Url Sccessfully...", Toast.LENGTH_SHORT).show();
