...
import com.example.stuffhub.Model.AdminOrders;
        ...
        FirebaseRecyclerAdapter<AdminOrders , AdminOrdersViewHolder> adapter =
                new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull AdminOrdersViewHolder holder, final int i, @NonNull final AdminOrders model)
                    {
                        ...
                        holder.userTotalPrice.setText("Total Amount=  $"+ model.getTotalAmount()+ " Pesos");
                        holder.userDateTime.setText("Order at: "+ model.getDate() + " "+ model.getTime());
                        holder.userShippingAddress.setText("Shipping Adress: "+ model.getAddress()+ ", "+ model.getCity());
